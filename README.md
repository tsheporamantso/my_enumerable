...
**My Enumerable** This is a app that takes a defined list of characters, strings, numbers or arrarys and performs some enumerable functions on them. The methods are defined in the module and used within the class. 
